...
internal class Program
{
    private static void Main()
    {
        ...
        Console.WriteLine("Sum of natural number to " + natural_num + " is " + sum_n_number_obj.sum_n_number_func(int.Parse(natural_num)));
        Console.WriteLine("Sum of natural number using n(n+1)/2 to " + natural_num + " is " + sum_n_number_obj.sum_n_number_func1(int.Parse(natural_num)) );
